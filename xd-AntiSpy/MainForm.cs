...
namespace xdAntiSpy
{
    public partial class MainForm : Form
    {
        ...
        private bool pluginButlerVisible = false;
        private bool pluginDebloaterVisible = false;
        ...
        {
            InitializeComponent();
            SetLanguageFromJson(); // Allow setting language from lang.json file (optional)
            InitializeLocalizedStrings();
            _ = InitializeLM(); // Fire and forget LM initialization
        }

        // Initialize LanguageManager
        public async Task InitializeLM()
        {
            // Initialize the LanguageManager instance
            languageManager = new LanguageManager();
            await languageManager.CheckAndPromptForLanguage();
        }
        ...
        {
            btnApply.Text = Strings.ctl_btnApply;

            undoContextItem.Text = Strings.menuUndoContextItem;
            doContextItem.Text = Strings.menuDoContextItem;
            pinContextItem.Text = Strings.menuPinContextItem;

            profilesToolStripMenuItem.Text = Strings.menu_profilesToolStripMenuItem;
            profileImportToolStripMenuItem.Text = Strings.menu_profilesImportToolStripMenuItem;
            profileExportToolStripMenuItem.Text = Strings.menu_profileExportToolStripMenuItem;
            profileStatisticsToolStripMenuItem.Text = Strings.menu_profileStatisticsToolStripMenuItem;
            profileShareToolStripMenuItem.Text = Strings.menu_profileShareSettingsToolStripMenuItem;
            toolsToolStripMenuItem.Text = Strings.menu_toolsToolStripMenuItem;
            toolsRefreshToolStripMenuItem.Text = Strings.menu_toolsRefreshToolStripMenuItem;
            modeToolStripMenuItem.Text = Strings.menu_modeToolStripMenuItem;
            modeStandardToolStripMenuItem.Text = Strings.menu_modeStandardToolStripMenuItem;
            modeAccessibleToolStripMenuItem.Text = Strings.menu_modeAccessibleToolStripMenuItem;
            aboutToolStripMenuItem.Text = Strings.menu_aboutToolStripMenuItem;
            aboutAppToolStripMenuItem.Text = Strings.menu_aboutToolStripMenuItem;
            aboutAppToolStripMenuItem.Text = Strings.menu_aboutAppToolStripMenuItem;
            aboutWebsiteToolStripMenuItem.Text = Strings.menu_aboutWebsiteToolStripMenuItem;
            aboutUpdateToolStripMenuItem.Text = Strings.menu_aboutUpdateToolStripMenuItem;
            aboutSymbolReferenceToolStripMenuItem.Text = Strings.menu_aboutSymbolReferenceToolStripMenuItem;
        }
        ...
        private void profileStatisticsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ProfileManager profileManager = new ProfileManager();
            profileManager.ShowStatistics(treeSettings);
        }
        ...
        private void changeLanguageToolStripMenuItem_Click(object sender, EventArgs e)
             => new LangManagerForm().ShowDialog();
        ...
        private bool LoadPlugin(string pluginFileName)
        {
            string pluginPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "plugins", pluginFileName);

            if (!File.Exists(pluginPath))
            {
                MessageBox.Show($"{pluginFileName} DLL not found!");
                return false;
            }
            ...
            try
            {
                ...
                bool pluginLoaded = false; // Flag to check if a plugin was successfully loaded
                ...
                if (!pluginLoaded)
                {
                    MessageBox.Show($"No valid plugin found in {pluginFileName} DLL.");
                    return false;
                }
            ...
            {
                MessageBox.Show($"Error loading plugin from {pluginFileName}: {ex.Message}");
                return false;
            }
        }

        private void pluginButlerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (pluginButlerVisible)
            {
                pluginButlerToolStripMenuItem.Checked = false;
                pluginPanel.Visible = false;
            }
            else
            {
                pluginPanel.Controls.Clear(); // Clear existing controls before loading a new plugin
                if (LoadPlugin("PluginButler.dll"))
                {
                    pluginPanel.Visible = true;
                    pluginButlerToolStripMenuItem.Checked = true;
                }
            }

            pluginButlerVisible = !pluginButlerVisible;
        }

        private void debloaterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (pluginDebloaterVisible)
            {
                debloaterToolStripMenuItem.Checked = false;
                pluginPanel.Visible = false;
            }
            else
            {
                ...
                if (LoadPlugin("PluginDebloater.dll"))
                {
                    pluginPanel.Visible = true;
                    debloaterToolStripMenuItem.Checked = true;
                }
            }

            pluginDebloaterVisible = !pluginDebloaterVisible;
        }

        // Allow setting optionally language from lang.json file
        private static void SetLanguageFromJson()
        {
            string filePath = "lang.json";
            ...
            try
            {
                ...
                string cultureCode = jsonObj.language;
            ...
            {
                MessageBox.Show($"Error reading language file: {ex.Message}");
        ...
        private static void SetLanguage(string cultureCode)
        {
            ...
            {
                //MessageBox.Show($"Culture {cultureCode} not found.");
